...
"https://github.com/bharathikannann/Python/blob/master/Blockchain/blockchain.py"
class Blockchain:
    def __init__(self):
        self.chain = []
        self.create_block(previous_hash='1', proof=100)

        """ Creating a block with four fields; index, timestamp, proof, previous hash """
...
plt.plot(range(1, rounds + 1), [acc * 100 for acc in accuracy_log], marker='o', color='pink')
plt.title("Blockchain Federated Learning Accuracy per round")
plt.xlabel("Round")
plt.ylabel("Accuracy (%)")
plt.ylim(0, 100)
plt.grid(True)
